    ...
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          ...
          title: Text('အရောင်းဘောင်ချာထုတ်ရန်',
            ...
            children: <Widget>[
              Padding(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    Text('Device:', style: Theme.of(context).textTheme.body1),
                    DropdownButton(
                    ...
                    RaisedButton(
                      onPressed: _pressed
                          ...
                          : _connected
                              ? _disconnect
                              : _connect,
                      child: Text(_connected ? 'မချိတ်ဆက်ပါ' : 'ချိတ်ဆက်သည်',
                          style: Theme.of(context).textTheme.title),
                    ),
                  ],
                ),
